...
async def nuke(ctx):
    ...
    channel_name = config.get("CHANNEL_NAME", "nuked by ddf code")
    webhook_name = config.get("WEBHOOK_NAME", "nuked by ddf code")
    message = config.get("MESSAGE", "@everyone")
    server_name = config.get("SERVER_NAME", "nuked by ddf code")
